...
- Production release `3ed3f1bff5a7119d066f75df03d3f59f5fc0b76b` includes readable history, current-message reply/proposal protection, identity checks, and the prior meal-description fix. The full suite passed 841/841 and strict local checks passed 14/14. Current activation and the user-waived WeChat acceptance scope are recorded in `docs/handoffs/2026-09-07-history-reply-audit.md`; earlier real chat acceptance remains in the preceding system audit.
