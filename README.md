...
- 当前版本包含跨插件实例记账修复和用餐描述按发送时间入账的规则，完整回归 768/768、本机检查 14/14 通过。“中午吃饭”“晚上吃饭”的真实微信加法记账与发送时间均已验证；较早的历史查询、汇总、金额查询及确认流程验收见[系统检查记录](docs/handoffs/2026-09-07-bookkeeping-system-audit.md)。各轮测试记录均已清理，账本恢复测试前基线。
