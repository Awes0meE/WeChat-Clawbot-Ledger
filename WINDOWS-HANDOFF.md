...
历史查询原始 JSON 的根因、回复来源保护、确认单与配置回滚修复集中见 [本轮审计](docs/handoffs/2026-09-07-history-reply-audit.md)。发布包 `3ed3f1bff5a7119d066f75df03d3f59f5fc0b76b` 已完成构建及完整文件校验，源码回归 841/841 通过。用户明确取消本轮真实微信验收，不能把较早聊天验收记作本次结果。
